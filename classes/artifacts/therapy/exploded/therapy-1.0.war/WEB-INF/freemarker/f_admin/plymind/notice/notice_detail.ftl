                        ...
                        <form>
                            <fieldset style="padding:10px;">
                                ...
                                <@am.bstrap_in_select name="allow_notice" title="공지사항/이벤트 구분">
                                    <option value="${mdv_no}" <#if documentEntity.allow_notice == mdv_no>selected</#if>>이벤트</option>
                                    <option value="${mdv_yes}"<#if documentEntity.allow_notice == mdv_yes>selected</#if>>공지사항</option>
                                </@am.bstrap_in_select>
...
<script type="text/javascript">
    ...
    <#-- 게시물 수정 -->
        ...
        moveuri="#${Request.contextPath}/admin/notice/list" errortitle="수정 실패" ; job >
            <#if job == "success_job">
    ...
    <#-- 댓글 등록 -->
        ...
        moveuri="#${Request.contextPath}/admin/notice/${documentEntity.document_srl}" errortitle="댓글 등록 실패" ; job >
            <#if job == "success_job">
