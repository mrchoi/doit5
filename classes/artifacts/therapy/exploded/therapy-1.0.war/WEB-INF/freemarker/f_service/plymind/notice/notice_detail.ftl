...
<!------------------------------------------------------------------------------------------->
<#assign _page_id="user-notice-detail">
<#assign _page_parent_name="공지사항/이벤트">
<#assign _page_current_name="공지사항/이벤트 보기">
            ...
            <div class="col-md-12">
                <div class="well-box">
                    <form >
                        ...
                        <!-- File -->
                        <#--<div class="form-group">
                            <label class="control-label" for="attach">사진첨부</label>
                            <div class="well"></div>
                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <#--<div class="btn-group pull-right">
                                <button id="submit" name="submit" class="btn tp-btn-primary" type="button">
...
$(document).ready(function() {
    ...
    <@am.jsevent_prevent />
        my.fn.pmove('${Request.contextPath}/user/notice/list');
    });
    ...
    <#-- 댓글 등록 -->
        ...
        <@ap.py_jsevent_prevent />
            ...
            if('${login_id}' == '-1') {<#--로그인 아이디 없을 시 댓글 등록 불가 처리-->
                $('#pop-message').text('댓글을 등록하기 위해 로그인을 하시기 바랍니다.');
                popup_layer();
                return;
            }
        ...
        moveuri="${Request.contextPath}/user/notice/${documentEntity.document_srl}" errortitle="댓글 등록 실패" ; job >
            <#if job == "success_job">
