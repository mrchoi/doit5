...
<#assign _page_id="one-add">
<#assign _page_parent_name="1:1 문의 게시판">
<#assign _page_current_name="1:1 문의 등록">
...
<script type="text/javascript">
    ...
    <#-- 게시물 추가 -->
        ...
        moveuri="#${Request.contextPath}/admin/one/list" errortitle="게시물 등록 실패" ; job >
            <#if job == "success_job">
            ...
            <#-- 게시물 등록 후 테이블의 1페이지를 보여 주기 위해서 테이블의 localStorage 를 삭제 시킨다. -->
                my.fn.removeDatatableStorage('faq_list');
