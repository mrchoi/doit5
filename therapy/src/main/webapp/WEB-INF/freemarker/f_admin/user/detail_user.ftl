<#assign _page_id="detail-user">
<#assign _page_parent_name="사용자 목록">
<#assign _page_current_name="사용자 정보">
...
<p>
    등록된 사용자 정보를 확인하고 수정하는 페이지 입니다.수정할 항목의 내용을 클릭하고 내용을 변경하면 곧바로 변경 됩니다. 상위 페이지인
                            ...
                            <div class="form-actions">
                                <div class="btn-group">
                                    <button id="btn-delete" class="btn btn-sm btn-danger" type="button">
                                        <i class="fa fa-trash-o"></i> 사용자 삭제
                                    </button>
                                </div>
                                <div class="btn-group pull-left">
                                    <button class="btn btn-sm btn-info btn-prev-page" type="button">
                                        <i class="fa fa-chevron-left"></i> 사용자 목록
                                    </button>
                                </div>
                            </div>
                        </form>
...
<script type="text/javascript">
    ...
    var pagefunction = function() {
        ...
        <@am.jsevent_prevent />
            my.fn.pmove('#${Request.contextPath}/admin/member/list');
        });
        ...
        $('#btn-delete').click(function(e){
            ...
            var successText = '${memberEntity.user_id} 사용자를 삭제 했습니다.';
            ...
            <@am.jsajax_request submituri="${Request.contextPath}/admin/member/t/"
                ...
                <#elseif job == "common_job">
                    $this.removeClass('disabled').html('<i class="fa fa-trash-o"></i> 사용자 삭제');
                </#if>
            </@am.jsajax_request>
            };

            my.fn.showUserConfirm('사용자 삭제',
                    "${memberEntity.user_id} 사용자를 삭제 합니다.<br/>삭제를 원하면 \'삭제\'를 입력 후 \'네\' 버튼을 클릭 하세요.",
                    '삭제를 입력하세요',
