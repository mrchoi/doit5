...
<!------------------------------------------------------------------------------------------->
<#assign _page_id="user-theme-detail">
<#assign _page_parent_name="테마공간">
<#assign _page_current_name="테마공간 보기">
...
$(document).ready(function() {
    ...
    <@am.jsevent_prevent />
        my.fn.pmove('${Request.contextPath}/user/theme/list');
    });

    $('#btn-modify').click(function(e){
    <@am.jsevent_prevent />
        my.fn.pmove('${Request.contextPath}/user/theme/modify/${documentEntity.document_srl}');
    });
    ...
    <@am.jsevent_prevent />
        ...
        <@am.jsajax_request submituri="${Request.contextPath}/user/board/document/t/"
    ...
    <#-- 댓글 등록 -->
        ...
        <#-- 댓글 등록 요청 -->
        <@am.jsajax_request submituri="${Request.contextPath}/user/board/document/comment/add/t/" method="POST"
        moveuri="${Request.contextPath}/user/theme/${documentEntity.document_srl}" errortitle="댓글 등록 실패" ; job >
            <#if job == "success_job">
    ...
    <#-- 댓글 삭제 요청 -->
        ...
        <@am.jsajax_request submituri="${Request.contextPath}/user/board/document/comment/t/"
