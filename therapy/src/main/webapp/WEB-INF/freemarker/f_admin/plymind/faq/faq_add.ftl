...
<#assign _page_id="faq-add">
<#assign _page_parent_name="FAQ 목록">
<#assign _page_current_name="FAQ 등록">
...
<script type="text/javascript">
    ...
    <#-- 게시물 추가 -->
        ...
        moveuri="#${Request.contextPath}/admin/faq/list" errortitle="게시물 등록 실패" ; job >
            <#if job == "success_job">
