...
<script type="text/javascript">
    ...
    <#-- 게시물 수정 -->
        ...
        moveuri="#${Request.contextPath}/admin/secret/list" errortitle="게시물 수정 실패" ; job >
            <#if job == "success_job">
    ...
    <#-- 댓글 등록 -->
        ...
        moveuri="#${Request.contextPath}/admin/secret/${documentEntity.document_srl}" errortitle="댓글 등록 실패" ; job >
            <#if job == "success_job">
