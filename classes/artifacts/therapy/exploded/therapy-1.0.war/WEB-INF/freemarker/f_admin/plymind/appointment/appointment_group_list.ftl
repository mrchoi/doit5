<#assign _page_id="appointment-appointment-group-list">
...
<script type="text/javascript">
    ...
    var pagefunction = function() {
        ...
        <@am.jsdatatable listId="${_page_id}" url="${Request.contextPath}/admin/plymind/appointment/group_list/t/" ; job>
            <#if job == "buttons">
                    []
            <#elseif job == "order">
                    [[0, 'desc']]
                ...
                [
                    ...
                    {sName: 'title', mData: 'title', sClass: 'text-center', bSortable: true, bSearchable: true,
                        mRender: function(data, type, full, dtObj) {
                            ...
                            var navHash = $(location).attr('hash').substring(1),
                                    moveURL = '#${Request.contextPath}/admin/plymind/appointment/appointment_application_list/' + full.application_group;
