...
public class AdminSentenceController {
    private final static Logger LOG = LoggerFactory.getLogger(AdminSentenceController.class);
    ...
    public String listTagForm(Model model) {
        ...
        model.addAttribute("category_srl_sentence", confAdmin.getProperty("plymind.sentence.category.srl"));

        return "f_admin/plymind/sentence/sentence_list";
    }
    ...
    public ModelAndView listDocument(HttpServletRequest request,
        ...
        String strCategorySrl = confAdmin.getProperty("plymind.sentence.category.srl");
    ...
    public String detailDocument(@PathVariable("document_srl") long documentSrl,
        ...
        TemplateEntity templateEntity = documentService.getDocumentTemplate(2);
        model.addAttribute("templateEntity", templateEntity);

        return "f_admin/plymind/sentence/sentence_detail";
    }
    ...
    public String addDocumentForm(Model model) {
        ...
        return "f_admin/plymind/sentence/sentence_add";
    }
    ...
    public ModelAndView addDocumentSubmit(HttpServletRequest request,
        ...
        sentenceService.addDocument(documentEntity);
