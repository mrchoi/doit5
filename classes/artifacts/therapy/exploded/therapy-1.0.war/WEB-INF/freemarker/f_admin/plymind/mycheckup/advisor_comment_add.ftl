<#assign _page_id="mycheckup-comment_add">
<#assign _page_parent_name="심리 검사 관리">
<#assign _page_current_name="심리 검사 상세정보">
    ...
    <div class="row">
        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            <div class="btn-group pull-left">
                <button id="btn-checkup-detail" class="btn btn-sm btn-info" type="button">
...
<script type="text/javascript">
    ...
    var pagefunction = function() {
        ...
        <#-- 심리검사 상세정보 페이지로 이동 -->
        $('#btn-checkup-detail').click(function(e) {
        <@am.jsevent_prevent />
            my.fn.pmove('#${Request.contextPath}/admin/mycheckup/${member_srl}/${application_group}');
        });
        ...
        $('#btn_comment_add').click(function(e) {
            ...
            if(advisor_comment == '') {
                ...
                <@am.jsnoti title="코멘트 확인" content="toastMsg" boxtype="warn" />
                return;
            }

            var checkup_file_srl = '';
           ...
           <@am.jsajax_request submituri="${Request.contextPath}/admin/mycheckup/advisor_comment_add/t/"
            moveuri="#${Request.contextPath}/admin/mycheckup/${member_srl}/${application_group}" errortitle="상담사 코멘트 등록 실패" ; job >
                <#if job == "success_job">
