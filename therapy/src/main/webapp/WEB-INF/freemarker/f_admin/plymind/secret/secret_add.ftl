                        ...
                        <div class="widget-footer smart-form">
                            ...
                            <div class="btn-group pull-left">
                                <button class="btn btn-sm btn-info btn-prev-page" type="button">
                                    <i class="fa fa-chevron-left"></i> 비밀게시판
                                </button>
                            </div>
...
<script type="text/javascript">
    ...
    <#-- 게시물 추가 -->
        ...
        moveuri="#${Request.contextPath}/admin/secret/list" errortitle="게시물 등록 실패" ; job >
            <#if job == "success_job">
            ...
            <#-- 게시물 등록 후 테이블의 1페이지를 보여 주기 위해서 테이블의 localStorage 를 삭제 시킨다. -->
                my.fn.removeDatatableStorage('secret_list');
