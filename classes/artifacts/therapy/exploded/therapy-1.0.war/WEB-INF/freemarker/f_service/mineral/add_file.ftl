    ...
    <div class="row">
        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget" id="wid-${_page_id}-0" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <@am.widget_title icon="fa-edit">임의 파일 등록</@am.widget_title>
...
<script type="text/javascript">
    ...
    var pagefunction = function() {
        ...
        $('#btn-add').click(function(e){
            ...
            <#-- 이미지 등록 요청 -->
            <@am.jsajax_request submituri="${Request.contextPath}/user/resource/repository/add/file/t/"
                    moveuri="#${Request.contextPath}/user/resource/repository/file/list" errortitle="임의 파일 등록 실패" ; job >
                <#if job == "success_job">
