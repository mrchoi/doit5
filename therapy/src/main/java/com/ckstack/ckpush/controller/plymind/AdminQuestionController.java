...
public class AdminQuestionController {
    private final static Logger LOG = LoggerFactory.getLogger(AdminQuestionController.class);
    ...
    public String listTagForm(Model model) {
        ...
        model.addAttribute("category_srl_question", confAdmin.getProperty("plymind.question.category.srl"));

        return "f_admin/plymind/question/question_list";
    }
    ...
    public ModelAndView listDocument(HttpServletRequest request,
        ...
        String strCategorySrl = confAdmin.getProperty("plymind.question.category.srl");
    ...
    public String detailDocument(@PathVariable("document_srl") long documentSrl,
        ...
        return "f_admin/plymind/question/question_detail";
    }
    ...
    public String addDocumentForm(Model model) {
        ...
        return "f_admin/plymind/question/question_add";
    }
