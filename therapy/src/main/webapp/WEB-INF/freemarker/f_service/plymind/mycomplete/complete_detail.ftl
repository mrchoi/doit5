...
<!------------------------------------------------------------------------------------------->
<#assign _page_id="user-mypage-complete-detail">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="well">
                   ...
                   <#-- <#if (applicationEntity.contents_srl == 1 || applicationEntity.contents_srl == 2) && applicationEntity.application_status == 1>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="well-box">
                    ...
                    <#--<#if applicationEntity.application_status?int &gt; 1 && applicationEntity.application_status?int &lt; 4>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title text-center" id="myModalLabel">[${advisorEntity.user_name}] 상담사 정보</h1>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#advisor_comment_more").click(function(e) {
            <@am.jsevent_prevent />
            my.fn.pmove('${Request.contextPath}/user/mycomplete/advisor_comment_view/${menu_type}/${applicationEntity.application_srl}/${applicationEntity.application_group}');
        });
