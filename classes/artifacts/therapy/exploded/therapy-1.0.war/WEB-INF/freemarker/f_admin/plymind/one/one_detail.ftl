    ...
    <#-- Push message history list start -->
        ...
        <#-- Push message history list Widget ID (each widget will need unique ID)-->
            <div class="jarviswidget" id="wid-${_page_id}-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                 data-widget-deletebutton="false">
                <@am.widget_title icon="fa-table">1:1 문의 답변</@am.widget_title>
                                                    ...
                                                    <div class="text-left">
                                                        <div class="comment-date">
                                                            ...
                                                            <div id="btn-comment-add" class="pull-right">
                                                                <a href="#" class="btn tp-btn-default">답변등록</a>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
    ...
    <#-- 게시판 관리로 이동 -->
        ...
        <@am.jsevent_prevent />
            my.fn.pmove('#${Request.contextPath}/admin/one/list');
        });
    ...
    <#-- 게시물 수정 -->
        ...
        moveuri="#${Request.contextPath}/admin/one/list" errortitle="게시물 수정 실패" ; job >
            <#if job == "success_job">
    ...
    <#-- 댓글 등록 -->
        ...
        moveuri="#${Request.contextPath}/admin/one/${documentEntity.document_srl}" errortitle="댓글 등록 실패" ; job >
            <#if job == "success_job">
