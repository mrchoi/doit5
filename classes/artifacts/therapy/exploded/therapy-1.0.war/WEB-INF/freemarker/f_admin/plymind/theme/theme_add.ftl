...
<@am.page_desc title="테마게시판 글쓰기" id="${_page_id}-helper">
<p>
</p>
</@am.page_desc>
...
<script type="text/javascript">
    ...
    <#-- 게시물 추가 -->
        ...
        moveuri="#${Request.contextPath}/admin/theme/list" errortitle="게시물 등록 실패" ; job >
            <#if job == "success_job">
            ...
            <#-- 게시물 등록 후 테이블의 1페이지를 보여 주기 위해서 테이블의 localStorage 를 삭제 시킨다. -->
                my.fn.removeDatatableStorage('theme_list');
