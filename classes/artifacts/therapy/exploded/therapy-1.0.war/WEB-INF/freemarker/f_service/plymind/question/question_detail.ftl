...
<#assign _page_current_name="문의게시판 보기">
                    ...
                    <form >
                        ...
                        <div class="form-group">
                            ...
                            <div class="btn-group pull-right">
                                <button id="btn-mod" name="submit" class="btn tp-btn-primary" type="button">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        <@am.jsevent_prevent />
            my.fn.pmove('${Request.contextPath}/user/question/modify/${documentEntity.document_srl}');
        });
        ...
        moveuri="${Request.contextPath}/user/question/${documentEntity.document_srl}" errortitle="댓글 등록 실패" ; job >
            <#if job == "success_job">
