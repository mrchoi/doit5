...
<!------------------------------------------------------------------------------------------->
<#assign _page_id="user-theme-add">
<#assign _page_parent_name="테마공간">
<#assign _page_current_name="테마공간 등록">
...
<script type="text/javascript">
    ...
    <#-- 게시물 추가 -->
        ...
        <@am.jsevent_prevent />
            ...
            if($.trim(docContent) == '') {
            <@ap.py_jsnoti title="디바이스 등록 실패" content="게시물 내용을 입력 하세요." contenttype="text" />
            return;
        }*/
        ...
        moveuri="${Request.contextPath}/user/theme/list" errortitle="게시물 등록 실패" ; job >
            <#if job == "success_job">
