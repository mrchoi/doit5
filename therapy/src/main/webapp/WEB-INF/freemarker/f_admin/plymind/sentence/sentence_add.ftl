...
<#assign _page_id="sentence_add">
<#assign _page_parent_name="너나들이 관리">
<#assign _page_current_name="너나들이 등록">
...
<section id="widget-grid" class="">
    <div class="row">
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <@am.widget_title icon="fa-edit">너나들이 등록</@am.widget_title>
                <div>
                    <div class="jarviswidget-editbox"><#-- This area used as dropdown edit box --></div>
                    <div class="widget-body">
                         <div>
                             <@am.bstrap_in_txt name="document_content" value="" title="문구" maxlength="64" placeholder="최대 64byte 까지 가능 합니다."/>
                         </div>
                        <div class="row">
...
<script type="text/javascript">
    ...
    var pagefunction = function() {
        ...
        $('#btn-add').click(function(e) {
            ...
            if($.trim(docContent) == '') {
                <@am.jsnoti title="너나들이 등록 실패" content="내용을 입력 하세요." contenttype="text" />
                return;
            }
            ...
            if(templateObj.send == 0) {
                <@am.jsnoti title="너나들이 등록 실패" content="발송 일시를 선택해 주세요" contenttype="text" />
                return;
            }
            ...
            var reqData = {
                ...
                block:              ${mdv_no},
                allow_comment:      ${mdv_no}, //1 댓글 허용함 2 댓글 허용하지 않음
                allow_notice:       ${mdv_no},
                list_order:         ${mdv_none},
            ...
            <#-- 너나들 등록 요청 -->
            <@am.jsajax_request submituri="${Request.contextPath}/admin/sentence/add/t/"
            moveuri="#${Request.contextPath}/admin/sentence/list" errortitle="너나들이 등록 실패" ; job >

            <#if job == "success_job">
            //너나들이 등록 성공하면 toast 메시지를 보여 준다
                var toastMsg = '너나들이를 등록 하였습니다.';
                <@am.jsnoti title="너나들이 등록 성공" content="toastMsg" boxtype="success" />
            ...
            //공통 작업. disabled 시킨 버튼을 enabled 시킨다
                $btnAdd.removeClass('disabled').html('<i class="fa fa-check"></i> 너나들이 등록');
            </#if>
