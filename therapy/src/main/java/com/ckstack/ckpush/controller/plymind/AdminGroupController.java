...
public class AdminGroupController {
    private final static Logger LOG = LoggerFactory.getLogger(AdminGroupController.class);
    ...
    public String listTagForm(Model model) {
        ...
        return "f_admin/plymind/group/group_list";
    }
    ...
    public ModelAndView listDocument(HttpServletRequest request,
        ...
        String strCategorySrl = confAdmin.getProperty("plymind.group.category.srl");
    ...
    public String detailDocument(@PathVariable("document_srl") long documentSrl,
        ...
        return "f_admin/plymind/group/group_detail";
    }
    ...
    public String addDocumentForm(Model model) {
        ...
        return "f_admin/plymind/group/group_add";
    }
